...
日期：2026-08-17（0.74 current reconciliation）

范围：记录两个已验收原型从独立调试到受控成员映射的状态；不表示全部植物成员配置完成。当前三组花叶关系已通过：洋水仙、风信子、狐尾百合。
...
5. 当前只定稿绑定洋水仙、风信子与狐尾百合，其他成员不得自动复用。
