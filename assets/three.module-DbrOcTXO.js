import{a0 as Ur,a as Dr,a1 as At,h as Ke,a2 as nr,s as Vt,V as ke,a3 as wr,a4 as lt,a5 as kt,a6 as tt,a7 as qt,a8 as _n,a9 as It,b as Mt,aa as _t,ab as Zt,ac as Ir,ad as yr,ae as mn,af as Nr,ag as Ft,ah as Or,ai as Fr,m as ft,P as cn,aj as Br,ak as Tt,al as un,am as zn,an as Qt,ao as Jt,ap as ir,aq as Gr,ar as Bt,as as pn,at as Hr,au as Vr,av as Yt,aw as kr,ax as Wr,ay as zr,az as Xr,aA as Yr,aB as qr,aC as Kr,aD as $r,aE as Zr,aF as Qr,aG as Jr,aH as jr,aI as ea,aJ as ta,aK as na,aL as ia,aM as ra,aN as aa,aO as Mn,aP as Gt,aQ as nn,aR as oa,aS as $t,aT as sa,aU as ca,aV as la,aW as fa,aX as rr,aY as da,aZ as ua,a_ as pa,a$ as ha,b0 as Be,b1 as _a,b2 as ma,b3 as va,E as yt,B as ar,b4 as ln,d as xt,b5 as or,b6 as wt,b7 as St,b8 as hn,b9 as sr,ba as cr,c as rn,bb as lr,J as fr,bc as ga,bd as Ea,be as Sa,bf as dr,bg as Dt,bh as Ma,bi as Ta,bj as xa,bk as Aa,bl as Ra,bm as ur,bn as Ca,bo as pr,bp as hr,bq as Tn,br as xn,bs as An,bt as Rn,bu as Ye,bv as jn,bw as ei,bx as ti,by as ni,bz as ii,bA as ri,bB as ai,bC as oi,bD as si,bE as ci,bF as li,bG as fi,bH as di,bI as ui,bJ as pi,bK as hi,bL as _i,bM as mi,bN as vi,bO as gi,bP as Ei,bQ as Cn,bR as Si,bS as Mi,bT as ba,bU as Ti,bV as xi,bW as Ai,bX as yn,bY as Nn,bZ as On,b_ as Fn,b$ as Bn,c0 as Gn,c1 as Hn,c2 as Pa,c3 as Ri,c4 as La,c5 as fn,c6 as Ua,c7 as Ci,c8 as bi,y as Pi,c9 as Vn,ca as kn,cb as Da,cc as _r,cd as wa,ce as vn,cf as Ia,cg as ya,ch as mr,ci as vr,cj as Li,ck as gr,cl as Ui,cm as Er,cn as jt,co as Wt,cp as Na,M as Oa,cq as Fa,cr as Ba,cs as Ga,ct as Di,cu as ct,cv as Ha,cw as Va,cx as ka,cy as Wa,cz as za,cA as Xa,cB as Ya,cC as qa,cD as Ka,cE as $a,cF as Za,cG as Qa,cH as Ja,cI as ja,cJ as eo,cK as to,cL as no}from"./three.core-DEHjaKId.js";/**
 * @license
 * Copyright 2010-2024 Three.js Authors
 * SPDX-License-Identifier: MIT
 */function Sr(){let e=null,n=!1,t=null,i=null;function c(o,h){t(o,h),i=e.requestAnimationFrame(c)}return{start:function(){n!==!0&&t!==null&&(i=e.requestAnimationFrame(c),n=!0)},stop:function(){e.cancelAnimationFrame(i),n=!1},setAnimationLoop:function(o){t=o},setContext:function(o){e=o}}}function io(e){const n=new WeakMap;function t(f,C){const g=f.array,b=f.usage,R=g.byteLength,E=e.createBuffer();e.bindBuffer(C,E),e.bufferData(C,g,b),f.onUploadCallback();let x;if(g instanceof Float32Array)x=e.FLOAT;else if(g instanceof Uint16Array)f.isFloat16BufferAttribute?x=e.HALF_FLOAT:x=e.UNSIGNED_SHORT;else if(g instanceof Int16Array)x=e.SHORT;else if(g instanceof Uint32Array)x=e.UNSIGNED_INT;else if(g instanceof Int32Array)x=e.INT;else if(g instanceof Int8Array)x=e.BYTE;else if(g instanceof Uint8Array)x=e.UNSIGNED_BYTE;else if(g instanceof Uint8ClampedArray)x=e.UNSIGNED_BYTE;else throw new Error("THREE.WebGLAttributes: Unsupported buffer data format: "+g);return{buffer:E,type:x,bytesPerElement:g.BYTES_PER_ELEMENT,version:f.version,size:R}}function i(f,C,g){const b=C.array,R=C.updateRanges;if(e.bindBuffer(g,f),R.length===0)e.bufferSubData(g,0,b);else{R.sort((x,N)=>x.start-N.start);let E=0;for(let x=1;x<R.length;x++){const N=R[E],P=R[x];P.start<=N.start+N.count+1?N.count=Math.max(N.count,P.start+P.count-N.start):(++E,R[E]=P)}R.length=E+1;for(let x=0,N=R.length;x<N;x++){const P=R[x];e.bufferSubData(g,P.start*b.BYTES_PER_ELEMENT,b,P.start,P.count)}C.clearUpdateRanges()}C.onUploadCallback()}function c(f){return f.isInterleavedBufferAttribute&&(f=f.data),n.get(f)}function o(f){f.isInterleavedBufferAttribute&&(f=f.data);const C=n.get(f);C&&(e.deleteBuffer(C.buffer),n.delete(f))}function h(f,C){if(f.isInterleavedBufferAttribute&&(f=f.data),f.isGLBufferAttribute){const b=n.get(f);(!b||b.version<f.version)&&n.set(f,{buffer:f.buffer,type:f.type,bytesPerElement:f.elementSize,version:f.version});return}const g=n.get(f);if(g===void 0)n.set(f,t(f,C));else if(g.version<f.version){if(g.size!==f.array.byteLength)throw new Error("THREE.WebGLAttributes: The size of the buffer attribute's array buffer does not match the original size. Resizing buffer attributes is not supported.");i(g.buffer,f,C),g.version=f.version}}return{get:c,remove:o,update:h}}var ro=`#ifdef USE_ALPHAHASH
...
void main() {
	...
	`}function qc(e){let n=new WeakMap,t=null;function i(f){if(f&&f.isTexture){const C=f.mapping,g=C===Vn||C===kn,b=C===jt||C===Wt;if(g||b){let R=n.get(f);const E=R!==void 0?R.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==E)return t===null&&(t=new Ni(e)),R=g?t.fromEquirectangular(f,R):t.fromCubemap(f,R),R.texture.pmremVersion=f.pmremVersion,n.set(f,R),R.texture;if(R!==void 0)return R.texture;{const x=f.image;return g&&x&&x.height>0||b&&x&&c(x)?(t===null&&(t=new Ni(e)),R=g?t.fromEquirectangular(f):t.fromCubemap(f),R.texture.pmremVersion=f.pmremVersion,n.set(f,R),f.addEventListener("dispose",o),R.texture):null}}}return f}function c(f){let C=0;const g=6;for(let b=0;b<g;b++)f[b]!==void 0&&C++;return C===g}function o(f){const C=f.target;C.removeEventListener("dispose",o);const g=n.get(C);g!==void 0&&(n.delete(C),g.dispose())}function h(){n=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:h}}function Kc(e){const n={};function t(i){if(n[i]!==void 0)return n[i];let c;switch(i){case"WEBGL_depth_texture":c=e.getExtension("WEBGL_depth_texture")||e.getExtension("MOZ_WEBGL_depth_texture")||e.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":c=e.getExtension("EXT_texture_filter_anisotropic")||e.getExtension("MOZ_EXT_texture_filter_anisotropic")||e.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":c=e.getExtension("WEBGL_compressed_texture_s3tc")||e.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||e.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":c=e.getExtension("WEBGL_compressed_texture_pvrtc")||e.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:c=e.getExtension(i)}return n[i]=c,c}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const c=t(i);return c===null&&Ft("THREE.WebGLRenderer: "+i+" extension not supported."),c}}}function $c(e,n,t,i){const c={},o=new WeakMap;function h(R){const E=R.target;E.index!==null&&n.remove(E.index);for(const N in E.attributes)n.remove(E.attributes[N]);E.removeEventListener("dispose",h),delete c[E.id];const x=o.get(E);x&&(n.remove(x),o.delete(E)),i.releaseStatesOfGeometry(E),E.isInstancedBufferGeometry===!0&&delete E._maxInstanceCount,t.memory.geometries--}function f(R,E){return c[E.id]===!0||(E.addEventListener("dispose",h),c[E.id]=!0,t.memory.geometries++),E}function C(R){const E=R.attributes;for(const x in E)n.update(E[x],e.ARRAY_BUFFER)}function g(R){const E=[],x=R.index,N=R.attributes.position;let P=0;if(x!==null){const I=x.array;P=x.version;for(let T=0,m=I.length;T<m;T+=3){const H=I[T+0],U=I[T+1],y=I[T+2];E.push(H,U,U,y,y,H)}}else if(N!==void 0){const I=N.array;P=N.version;for(let T=0,m=I.length/3-1;T<m;T+=3){const H=T+0,U=T+1,y=T+2;E.push(H,U,U,y,y,H)}}else return;const l=new(Ga(E)?Fa:Ba)(E,1);l.version=P;const r=o.get(R);r&&n.remove(r),o.set(R,l)}function b(R){const E=o.get(R);if(E){const x=R.index;x!==null&&E.version<x.version&&g(R)}else g(R);return o.get(R)}return{get:f,update:C,getWireframeAttribute:b}}function Zc(e,n,t){let i;function c(E){i=E}let o,h;function f(E){o=E.type,h=E.bytesPerElement}function C(E,x){e.drawElements(i,x,o,E*h),t.update(x,i,1)}function g(E,x,N){N!==0&&(e.drawElementsInstanced(i,x,o,E*h,N),t.update(x,i,N))}function b(E,x,N){if(N===0)return;n.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,x,0,o,E,0,N);let l=0;for(let r=0;r<N;r++)l+=x[r];t.update(l,i,1)}function R(E,x,N,P){if(N===0)return;const l=n.get("WEBGL_multi_draw");if(l===null)for(let r=0;r<E.length;r++)g(E[r]/h,x[r],P[r]);else{l.multiDrawElementsInstancedWEBGL(i,x,0,o,E,0,P,0,N);let r=0;for(let I=0;I<N;I++)r+=x[I]*P[I];t.update(r,i,1)}}this.setMode=c,this.setIndex=f,this.render=C,this.renderInstances=g,this.renderMultiDraw=b,this.renderMultiDrawInstances=R}function Qc(e){const n={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(o,h,f){switch(t.calls++,h){case e.TRIANGLES:t.triangles+=f*(o/3);break;case e.LINES:t.lines+=f*(o/2);break;case e.LINE_STRIP:t.lines+=f*(o-1);break;case e.LINE_LOOP:t.lines+=f*o;break;case e.POINTS:t.points+=f*o;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",h);break}}function c(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:n,render:t,programs:null,autoReset:!0,reset:c,update:i}}function Jc(e,n,t){const i=new WeakMap,c=new lt;function o(h,f,C){const g=h.morphTargetInfluences,b=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,R=b!==void 0?b.length:0;let E=i.get(f);if(E===void 0||E.count!==R){let p=function(){y.dispose(),i.delete(f),f.removeEventListener("dispose",p)};E!==void 0&&E.texture.dispose();const x=f.morphAttributes.position!==void 0,N=f.morphAttributes.normal!==void 0,P=f.morphAttributes.color!==void 0,l=f.morphAttributes.position||[],r=f.morphAttributes.normal||[],I=f.morphAttributes.color||[];let T=0;x===!0&&(T=1),N===!0&&(T=2),P===!0&&(T=3);let m=f.attributes.position.count*T,H=1;m>n.maxTextureSize&&(H=Math.ceil(m/n.maxTextureSize),m=n.maxTextureSize);const U=new Float32Array(m*H*4*R),y=new _r(U,m,H,R);y.type=Dt,y.needsUpdate=!0;const B=T*4;for(let d=0;d<R;d++){const A=l[d],q=r[d],V=I[d],Y=m*H*4*d;for(let Q=0;Q<A.count;Q++){const W=Q*B;x===!0&&(c.fromBufferAttribute(A,Q),U[Y+W+0]=c.x,U[Y+W+1]=c.y,U[Y+W+2]=c.z,U[Y+W+3]=0),N===!0&&(c.fromBufferAttribute(q,Q),U[Y+W+4]=c.x,U[Y+W+5]=c.y,U[Y+W+6]=c.z,U[Y+W+7]=0),P===!0&&(c.fromBufferAttribute(V,Q),U[Y+W+8]=c.x,U[Y+W+9]=c.y,U[Y+W+10]=c.z,U[Y+W+11]=V.itemSize===4?c.w:1)}}E={count:R,texture:y,size:new ft(m,H)},i.set(f,E),f.addEventListener("dispose",p)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)C.getUniforms().setValue(e,"morphTexture",h.morphTexture,t);else{let x=0;for(let P=0;P<g.length;P++)x+=g[P];const N=f.morphTargetsRelative?1:1-x;C.getUniforms().setValue(e,"morphTargetBaseInfluence",N),C.getUniforms().setValue(e,"morphTargetInfluences",g)}C.getUniforms().setValue(e,"morphTargetsTexture",E.texture,t),C.getUniforms().setValue(e,"morphTargetsTextureSize",E.size)}return{update:o}}function jc(e,n,t,i){let c=new WeakMap;function o(C){const g=i.render.frame,b=C.geometry,R=n.get(C,b);if(c.get(R)!==g&&(n.update(R),c.set(R,g)),C.isInstancedMesh&&(C.hasEventListener("dispose",f)===!1&&C.addEventListener("dispose",f),c.get(C)!==g&&(t.update(C.instanceMatrix,e.ARRAY_BUFFER),C.instanceColor!==null&&t.update(C.instanceColor,e.ARRAY_BUFFER),c.set(C,g))),C.isSkinnedMesh){const E=C.skeleton;c.get(E)!==g&&(E.update(),c.set(E,g))}return R}function h(){c=new WeakMap}function f(C){const g=C.target;g.removeEventListener("dispose",f),t.remove(g.instanceMatrix),g.instanceColor!==null&&t.remove(g.instanceColor)}return{update:o,dispose:h}}const Mr=new lr,Gi=new ir(1,1),Tr=new _r,xr=new Za,Ar=new $a,Hi=[],Vi=[],ki=new Float32Array(16),Wi=new Float32Array(9),zi=new Float32Array(4);function zt(e,n,t){const i=e[0];if(i<=0||i>0)return e;const c=n*t;let o=Hi[c];if(o===void 0&&(o=new Float32Array(c),Hi[c]=o),n!==0){i.toArray(o,0);for(let h=1,f=0;h!==n;++h)f+=t,e[h].toArray(o,f)}return o}function nt(e,n){if(e.length!==n.length)return!1;for(let t=0,i=e.length;t<i;t++)if(e[t]!==n[t])return!1;return!0}function it(e,n){for(let t=0,i=n.length;t<i;t++)e[t]=n[t]}function gn(e,n){let t=Vi[n];t===void 0&&(t=new Int32Array(n),Vi[n]=t);for(let i=0;i!==n;++i)t[i]=e.allocateTextureUnit();return t}function el(e,n){const t=this.cache;t[0]!==n&&(e.uniform1f(this.addr,n),t[0]=n)}function tl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2f(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(nt(t,n))return;e.uniform2fv(this.addr,n),it(t,n)}}function nl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3f(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else if(n.r!==void 0)(t[0]!==n.r||t[1]!==n.g||t[2]!==n.b)&&(e.uniform3f(this.addr,n.r,n.g,n.b),t[0]=n.r,t[1]=n.g,t[2]=n.b);else{if(nt(t,n))return;e.uniform3fv(this.addr,n),it(t,n)}}function il(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4f(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(nt(t,n))return;e.uniform4fv(this.addr,n),it(t,n)}}function rl(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(nt(t,n))return;e.uniformMatrix2fv(this.addr,!1,n),it(t,n)}else{if(nt(t,i))return;zi.set(i),e.uniformMatrix2fv(this.addr,!1,zi),it(t,i)}}function al(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(nt(t,n))return;e.uniformMatrix3fv(this.addr,!1,n),it(t,n)}else{if(nt(t,i))return;Wi.set(i),e.uniformMatrix3fv(this.addr,!1,Wi),it(t,i)}}function ol(e,n){const t=this.cache,i=n.elements;if(i===void 0){if(nt(t,n))return;e.uniformMatrix4fv(this.addr,!1,n),it(t,n)}else{if(nt(t,i))return;ki.set(i),e.uniformMatrix4fv(this.addr,!1,ki),it(t,i)}}function sl(e,n){const t=this.cache;t[0]!==n&&(e.uniform1i(this.addr,n),t[0]=n)}function cl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2i(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(nt(t,n))return;e.uniform2iv(this.addr,n),it(t,n)}}function ll(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3i(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else{if(nt(t,n))return;e.uniform3iv(this.addr,n),it(t,n)}}function fl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4i(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(nt(t,n))return;e.uniform4iv(this.addr,n),it(t,n)}}function dl(e,n){const t=this.cache;t[0]!==n&&(e.uniform1ui(this.addr,n),t[0]=n)}function ul(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y)&&(e.uniform2ui(this.addr,n.x,n.y),t[0]=n.x,t[1]=n.y);else{if(nt(t,n))return;e.uniform2uiv(this.addr,n),it(t,n)}}function pl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z)&&(e.uniform3ui(this.addr,n.x,n.y,n.z),t[0]=n.x,t[1]=n.y,t[2]=n.z);else{if(nt(t,n))return;e.uniform3uiv(this.addr,n),it(t,n)}}function hl(e,n){const t=this.cache;if(n.x!==void 0)(t[0]!==n.x||t[1]!==n.y||t[2]!==n.z||t[3]!==n.w)&&(e.uniform4ui(this.addr,n.x,n.y,n.z,n.w),t[0]=n.x,t[1]=n.y,t[2]=n.z,t[3]=n.w);else{if(nt(t,n))return;e.uniform4uiv(this.addr,n),it(t,n)}}function _l(e,n,t){const i=this.cache,c=t.allocateTextureUnit();i[0]!==c&&(e.uniform1i(this.addr,c),i[0]=c);let o;this.type===e.SAMPLER_2D_SHADOW?(Gi.compareFunction=rr,o=Gi):o=Mr,t.setTexture2D(n||o,c)}function ml(e,n,t){const i=this.cache,c=t.allocateTextureUnit();i[0]!==c&&(e.uniform1i(this.addr,c),i[0]=c),t.setTexture3D(n||xr,c)}function vl(e,n,t){const i=this.cache,c=t.allocateTextureUnit();i[0]!==c&&(e.uniform1i(this.addr,c),i[0]=c),t.setTextureCube(n||Ar,c)}function gl(e,n,t){const i=this.cache,c=t.allocateTextureUnit();i[0]!==c&&(e.uniform1i(this.addr,c),i[0]=c),t.setTexture2DArray(n||Tr,c)}function El(e){switch(e){case 5126:return el;case 35664:return tl;case 35665:return nl;case 35666:return il;case 35674:return rl;case 35675:return al;case 35676:return ol;case 5124:case 35670:return sl;case 35667:case 35671:return cl;case 35668:case 35672:return ll;case 35669:case 35673:return fl;case 5125:return dl;case 36294:return ul;case 36295:return pl;case 36296:return hl;case 35678:case 36198:case 36298:case 36306:case 35682:return _l;case 35679:case 36299:case 36307:return ml;case 35680:case 36300:case 36308:case 36293:return vl;case 36289:case 36303:case 36311:case 36292:return gl}}function Sl(e,n){e.uniform1fv(this.addr,n)}function Ml(e,n){const t=zt(n,this.size,2);e.uniform2fv(this.addr,t)}function Tl(e,n){const t=zt(n,this.size,3);e.uniform3fv(this.addr,t)}function xl(e,n){const t=zt(n,this.size,4);e.uniform4fv(this.addr,t)}function Al(e,n){const t=zt(n,this.size,4);e.uniformMatrix2fv(this.addr,!1,t)}function Rl(e,n){const t=zt(n,this.size,9);e.uniformMatrix3fv(this.addr,!1,t)}function Cl(e,n){const t=zt(n,this.size,16);e.uniformMatrix4fv(this.addr,!1,t)}function bl(e,n){e.uniform1iv(this.addr,n)}function Pl(e,n){e.uniform2iv(this.addr,n)}function Ll(e,n){e.uniform3iv(this.addr,n)}function Ul(e,n){e.uniform4iv(this.addr,n)}function Dl(e,n){e.uniform1uiv(this.addr,n)}function wl(e,n){e.uniform2uiv(this.addr,n)}function Il(e,n){e.uniform3uiv(this.addr,n)}function yl(e,n){e.uniform4uiv(this.addr,n)}function Nl(e,n,t){const i=this.cache,c=n.length,o=gn(t,c);nt(i,o)||(e.uniform1iv(this.addr,o),it(i,o));for(let h=0;h!==c;++h)t.setTexture2D(n[h]||Mr,o[h])}function Ol(e,n,t){const i=this.cache,c=n.length,o=gn(t,c);nt(i,o)||(e.uniform1iv(this.addr,o),it(i,o));for(let h=0;h!==c;++h)t.setTexture3D(n[h]||xr,o[h])}function Fl(e,n,t){const i=this.cache,c=n.length,o=gn(t,c);nt(i,o)||(e.uniform1iv(this.addr,o),it(i,o));for(let h=0;h!==c;++h)t.setTextureCube(n[h]||Ar,o[h])}function Bl(e,n,t){const i=this.cache,c=n.length,o=gn(t,c);nt(i,o)||(e.uniform1iv(this.addr,o),it(i,o));for(let h=0;h!==c;++h)t.setTexture2DArray(n[h]||Tr,o[h])}function Gl(e){switch(e){case 5126:return Sl;case 35664:return Ml;case 35665:return Tl;case 35666:return xl;case 35674:return Al;case 35675:return Rl;case 35676:return Cl;case 5124:case 35670:return bl;case 35667:case 35671:return Pl;case 35668:case 35672:return Ll;case 35669:case 35673:return Ul;case 5125:return Dl;case 36294:return wl;case 36295:return Il;case 36296:return yl;case 35678:case 36198:case 36298:case 36306:case 35682:return Nl;case 35679:case 36299:case 36307:return Ol;case 35680:case 36300:case 36308:case 36293:return Fl;case 36289:case 36303:case 36311:case 36292:return Bl}}class Hl{constructor(n,t,i){this.id=n,this.addr=i,this.cache=[],this.type=t.type,this.setValue=El(t.type)}}class Vl{constructor(n,t,i){this.id=n,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Gl(t.type)}}class kl{constructor(n){this.id=n,this.seq=[],this.map={}}setValue(n,t,i){const c=this.seq;for(let o=0,h=c.length;o!==h;++o){const f=c[o];f.setValue(n,t[f.id],i)}}}const wn=/(\w+)(\])?(\[|\.)?/g;function Xi(e,n){e.seq.push(n),e.map[n.id]=n}function Wl(e,n,t){const i=e.name,c=i.length;for(wn.lastIndex=0;;){const o=wn.exec(i),h=wn.lastIndex;let f=o[1];const C=o[2]==="]",g=o[3];if(C&&(f=f|0),g===void 0||g==="["&&h+2===c){Xi(t,g===void 0?new Hl(f,e,n):new Vl(f,e,n));break}else{let R=t.map[f];R===void 0&&(R=new kl(f),Xi(t,R)),t=R}}}class dn{constructor(n,t){this.seq=[],this.map={};const i=n.getProgramParameter(t,n.ACTIVE_UNIFORMS);for(let c=0;c<i;++c){const o=n.getActiveUniform(t,c),h=n.getUniformLocation(t,o.name);Wl(o,h,this)}}setValue(n,t,i,c){const o=this.map[t];o!==void 0&&o.setValue(n,i,c)}setOptional(n,t,i){const c=t[i];c!==void 0&&this.setValue(n,i,c)}static upload(n,t,i,c){for(let o=0,h=t.length;o!==h;++o){const f=t[o],C=i[f.id];C.needsUpdate!==!1&&f.setValue(n,C.value,c)}}static seqWithValue(n,t){const i=[];for(let c=0,o=n.length;c!==o;++c){const h=n[c];h.id in t&&i.push(h)}return i}}function Yi(e,n,t){const i=e.createShader(n);return e.shaderSource(i,t),e.compileShader(i),i}const zl=37297;let Xl=0;function Yl(e,n){const t=e.split(`
`),i=[],c=Math.max(n-6,0),o=Math.min(n+6,t.length);for(let h=c;h<o;h++){const f=h+1;i.push(`${f===n?">":" "} ${f}: ${t[h]}`)}return i.join(`
`)}const qi=new Be;function ql(e){tt._getMatrix(qi,tt.workingColorSpace,e);const n=`mat3( ${qi.elements.map(t=>t.toFixed(4))} )`;switch(tt.getTransfer(e)){case Er:return[n,"LinearTransferOETF"];case Ye:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",e),[n,"LinearTransferOETF"]}}function Ki(e,n,t){const i=e.getShaderParameter(n,e.COMPILE_STATUS),c=e.getShaderInfoLog(n).trim();if(i&&c==="")return"";const o=/ERROR: 0:(\d+)/.exec(c);if(o){const h=parseInt(o[1]);return t.toUpperCase()+`

`+c+`

`+Yl(e.getShaderSource(n),h)}else return c}function Kl(e,n){const t=ql(n);return[`vec4 ${e}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function $l(e,n){let t;switch(n){case Ka:t="Linear";break;case qa:t="Reinhard";break;case Ya:t="Cineon";break;case Xa:t="ACESFilmic";break;case za:t="AgX";break;case Wa:t="Neutral";break;case ka:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",n),t="Linear"}return"vec3 "+e+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const sn=new ke;function Zl(){tt.getLuminanceCoefficients(sn);const e=sn.x.toFixed(4),n=sn.y.toFixed(4),t=sn.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${e}, ${n}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Ql(e){return[e.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",e.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Kt).join(`
...
`)+`
`+r);const T=I+l+h,m=I+r+f,H=Yi(c,c.VERTEX_SHADER,T),U=Yi(c,c.FRAGMENT_SHADER,m);c.attachShader(P,H),c.attachShader(P,U),t.index0AttributeName!==void 0?c.bindAttribLocation(P,0,t.index0AttributeName):t.morphTargets===!0&&c.bindAttribLocation(P,0,"position"),c.linkProgram(P);function y(A){if(e.debug.checkShaderErrors){const q=c.getProgramInfoLog(P).trim(),V=c.getShaderInfoLog(H).trim(),Y=c.getShaderInfoLog(U).trim();let Q=!0,W=!0;if(c.getProgramParameter(P,c.LINK_STATUS)===!1)if(Q=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(c,P,H,U);else{const j=Ki(c,H,"vertex"),F=Ki(c,U,"fragment");console.error("THREE.WebGLProgram: Shader Error "+c.getError()+" - VALIDATE_STATUS "+c.getProgramParameter(P,c.VALIDATE_STATUS)+`
