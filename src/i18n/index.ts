...
export const translations: Record<Locale, TranslationTree> = {
  en: {
    ...
    platforms: {
      ...
      macDownloadHost: 'Feishu and OneDrive are mirrors for the same architecture packages. Choose the mirror that opens normally in your browser.',
      ...
      windowsSourceTitle: 'Choose a download source',
      windowsRecommended: 'Recommended',
      windowsFallback: 'Backup',
      windowsOneDriveTitle: 'OneDrive',
      windowsOneDriveBody: 'Use OneDrive first if it opens normally on your device.',
      windowsFeishuTitle: 'Feishu backup',
      windowsFeishuBody: 'If OneDrive cannot be opened, use these Feishu links instead.',
      ...
      windowsDownloadHost: 'Choose OneDrive first. If it does not open, use the Feishu backup links. Verify SHA-256 before opening the package.',
  ...
  'zh-CN': {
    ...
    platforms: {
      ...
      macDownloadHost: '飞书和 OneDrive 是同一架构安装包的镜像。请选择你浏览器中能正常打开的镜像。',
      macSystemLabel: '系统',
      ...
      windowsSourceTitle: '选择下载来源',
      windowsRecommended: '推荐',
      windowsFallback: '备用',
      windowsOneDriveTitle: 'OneDrive 下载',
      windowsOneDriveBody: '如果 OneDrive 可以正常打开，优先使用这里。',
      windowsFeishuTitle: '飞书备用下载',
      windowsFeishuBody: '如果 OneDrive 无法打开，请改用这里的飞书链接。',
      ...
      windowsOpen: '查看下载',
      windowsDownloadHost: '请先尝试 OneDrive；如果无法打开，再使用飞书备用链接。打开前请核对 SHA-256。',
