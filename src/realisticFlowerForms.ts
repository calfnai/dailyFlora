...
export const realisticFlowerDefinitions: RealisticFlowerDefinition[] = [
  ...
  { id: 'lace-flower', frozen: true, cn: '蕾丝花', en: 'Lace Flower', scientificName: 'Ammi majus', category: 'cluster', description: '中心节点放射 16 根不等长一级伞梗；中央、中层与外围小伞簇保持受控密度和自然缺口，整体形成浅拱。', calibration: '冻结：独立 LAB 骨架与密度复审通过；保留 6–10 朵五瓣微花 / 花蕾的小伞簇，不做白色花盘。', scopeNote: calibratedScopeNote, palette: ['#fffdf0', '#f5eed4', '#e6cf78', '#5e7d52'], printStructure: '所有微花经二级伞梗、一级伞梗汇回中心主花梗。' },
