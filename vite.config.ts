  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        snapdragonApprovalLab: resolve(__dirname, 'docs/snapdragon-approval-lab.html'),
        hyacinthApprovalLab: resolve(__dirname, 'docs/hyacinth-approval-lab.html'),
        liatrisApprovalLab: resolve(__dirname, 'docs/liatris-approval-lab.html'),
